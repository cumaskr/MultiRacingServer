...
else
{
    ...
    while($item_row = mysqli_fetch_array($item_query))
    {
        ...
        //아이템 목록을 전체 돌면서 우선 차만 처리해준다. 차는 다 가져와야한다.
        ...
        else if(strcmp($item_row['m_type'],'wheel') == 0 && $memberInventory_row['m_equip'] == 1)
        {
